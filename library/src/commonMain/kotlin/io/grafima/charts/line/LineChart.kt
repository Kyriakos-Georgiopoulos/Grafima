...
fun LineChart(
    ...
    val xMin = remember(allPoints, axisConfig.xMin) {
        axisConfig.xMin ?: allPoints.minOfOrNull { it.x } ?: 0f
    }
    val xMax = remember(allPoints, axisConfig.xMax) {
        axisConfig.xMax ?: allPoints.maxOfOrNull { it.x } ?: 1f
    }
